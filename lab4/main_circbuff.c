...
Int16 coefs[IR_length] = {194,    872,   2181,   3780,   4907,   4907,   3780,   2181,    872,
      194};
Int16 leftsample, rightsample;
Int16 input;
Int16 output, count=0;
/* ------------------------------------------------------------------------ *
 *                                                                          *
 *  Testing Function                                                        *
 *                                                                          *
 ...
 *                                                                          *
 * ------------------------------------------------------------------------ */
Int16 recent_output[100], recent_input[100];
main( void )
{
	/* Initialize BSL */
	int j=0;
    ...
    //	I2S2_W0_MSW_W = 20*output;
    //  	I2S2_W1_MSW_W = 20*output;
      	
      	
      	recent_output[j]=20*output;
